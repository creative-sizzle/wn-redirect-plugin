...
return [
    ...
    */
    ...
    'cron' => [
        'publish_redirects' => env('CS_REDIRECT_CRON_PUBLISH_REDIRECTS', '00:00'),
    ],
    ...
    */
    ...
    'log_redirect_changes' => (bool) env('CS_REDIRECT_LOG_REDIRECT_CHANGES', false),
    ...
    */
    ...
    'rules_path' => env('CS_REDIRECT_RULES_PATH', storage_path('app/redirects.csv')),
