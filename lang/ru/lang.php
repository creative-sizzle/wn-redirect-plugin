...
return [
    ...
    'settings' => [
        ...
        'caching_enabled_comment' => 'Улучшает механизм перенаправления при большом количестве перенаправлений. ВНИМАНИЕ: Драйвер кэша `file` и `database` НЕ поддерживаются. Рекомендуемым драйвером является `memcached` или аналогичный драйвер "in-memory" для кеширования в памяти.',
    ...
    'redirect' => [
        ...
        'from_scheme_comment' => 'Принудительное совпадение протоколов. Если выбранное HTTP путь: <u>http://domain.com/path</u> не совпадет с <u>https://domain.com/path</u>.',
        ...
        'to_scheme_comment' => 'Целевой протокол принудительно установит HTTP или HTTPS Используйте "Авто" для использования стандартного протокола веб-сайта.',
        'scheme_auto' => 'Авто',
        ...
        'cache_warning' => 'Вы включили кэширование, но ваш драйвер кэширования не поддерживается. Перенаправления не будут кэшироваться.',
    ...
    'test_lab' => [
        ...
        'test_lab_path_comment' => 'Этот путь будет использован для тестов. Замените плейсхолдеры с реальными значениями.',
        ...
        'no_redirects' => 'Нет отмеченных редиректов с включенным TestLab. Пожалуйста, включите опцию \'Включить в TestLab\' в редактировании редиректа.',
        ...
        'matched' => 'Совпало',
        'redirect' => 'редирект',
        'matched_not_http_code' => 'Совпавший редирект, но код ответа HTTP не совпал! Ожидалось :expected но получено :received.',
